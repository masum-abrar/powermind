  ...
  const slides = [
    {
      ...
      description:
        "Cutting-edge vertical transportation systems tailored to your building's needs",
      image:
    ...
    },
    {
      ...
      description:
        '24/7 professional maintenance to keep your lifts running smoothly',
      image:
    ...
    {
      title: 'Smart Lift Technology',
      description:
        'AI-powered elevators with predictive maintenance and energy efficiency',
      image:
            ...
            <div className='relative flex flex-col justify-center p-8 md:p-12 lg:p-16 h-full text-white'>
              <div className='space-y-6 max-w-2xl'>
                ...
                <div className='flex flex-wrap gap-4 pt-4'>
                  <button className='bg-gradient-to-r from-yellow-500 hover:from-yellow-600 to-orange-600 hover:to-orange-700 shadow-lg hover:shadow-xl px-8 py-3 rounded-lg font-medium transition-all hover:-translate-y-1 duration-300'>
                    {slide.cta}
                  </button>
